...
<div id="main_list">
	<div id="main_list_left">
			<div id="main_list_left_top">
				您的位置：<a href="index.php">首页</a>=><a href="gyaq.php">公寓安全</a>
			</div>
			<div id="main_list_left_middle">
				<div id="main_list_left_title">
					<ul>
							<?
							$query=mysql_query("SELECT * FROM `gyaq` ORDER BY `gyaq_time` desc  LIMIT $start_page, $xsgs");
							while($row=mysql_fetch_array($query)){
							?>
								<li><a href="gyaq_content.php?id=<?php echo $row[gyaq_id]?>"><?php echo $row[gyaq_title]?></a></li>
							<?
							}
							?>
