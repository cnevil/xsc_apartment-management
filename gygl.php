...
if(isset($_GET[page])){
	...
	$query_page=mysql_query("SELECT * FROM `gygl`");//修改取出的数据库d
...
<div id="main_list">
	<div id="main_list_left">
			<div id="main_list_left_top">
				您的位置：<a href="index.php">首页</a>=><a href="gygl.php">公寓管理</a>
			</div>
			<div id="main_list_left_middle">
				<div id="main_list_left_title">
					<ul>
							<?
							$query=mysql_query("SELECT * FROM `gygl` ORDER BY `gygl_time` desc  LIMIT $start_page, $xsgs");
							while($row=mysql_fetch_array($query)){
							?>
								<li><a href="gygl_content.php?id=<?php echo $row[gygl_id]?>"><?php echo $row[gygl_title]?></a></li>
							<?
							}
							?>
