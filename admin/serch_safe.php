...
if(isset($_GET[page])){
	...
	$query_page=mysql_query("SELECT * FROM `ip_time_jl` WHERE `ip`='$serch_tj' OR `time`='$serch_tj'");
			...
			<div id="content">
				<table width="100%" height="25" border="1px" cellpadding="0" cellspacing="0" bordercolor="d6dbdf">
                	<tr bgcolor="e7ecf1">
                    	...
                    	$sql="SELECT * FROM `ip_time_jl` WHERE `ip`='$serch_tj' OR `time`='$serch_tj' ORDER BY `time` $sql_order LIMIT $start_page,$xsgs";
