			...
			<div id="content">
				<table width="100%" height="25" border="1px" cellpadding="0" cellspacing="0" bordercolor="d6dbdf">
                	<tr bgcolor="e7ecf1">
                    	...
                    	<td width="22%" align="center"><span id="lb_head">
                    	<!--修改标题-->图片名称</a></span>&nbsp;&nbsp;
						</td>
						<td width="22%" align="center"><span id="lb_head">
						<!--修改为本页面--><!--修改标题-->链接地址</a></span>&nbsp;&nbsp;
						</td>
                    	<td width="22%"  align="center"><span id="lb_head">栏目图片</span></td>
						<td width="12%" align="center"><span id="lb_head_cz">操作&nbsp;&nbsp;</span></td>
                    </tr>
                </table>
                ...
                <table width="100%" height="25" border="1px" cellpadding="0" cellspacing="0" bgcolor="" bordercolor="#acadad">
                    <?php
                   		$sql_sel = "SELECT * FROM `zt` where `id`=2";
						$query_sel = mysql_query($sql_sel);
						while ($row = mysql_fetch_array($query_sel)) {
                    ?>
                        	<td width="22%" align="center"><?php echo $row[zt_name]?></td><!--修改显示名称-->
						<td width="22%" align="center"><?php echo $row[zt_url]?></td><!--修改显示时间-->
						<td width="22%" align="center"><?php echo"<img src=\"../images/zt_".$row[id].".jpg\""." width=122px height=74px>" ;?></td><!--修改显示时间-->
						<td width="12%" align="center"><!--修改俩处del的值和取消的页面-->
						&nbsp;&nbsp;<input id="cz" type="button" value="修改" onclick="location.href='zt_2_upload.php?upload=<?php echo $row[id]?>'"/>&nbsp;&nbsp;<!--修改俩处upload的值和添加的页面--> </td>
                    </tr>
                   <?php
                   }
                  ?>
