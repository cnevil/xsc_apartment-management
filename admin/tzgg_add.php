...
if(isset($_POST[sub]))
{    $sql = "INSERT INTO `tzgg` (`tzgg_id`, `tzgg_title`, `tzgg_content`, `tzgg_time`) VALUES (NULL, '$_POST[ldjh_title]','$_POST[ldjh_content]', '$_POST[ldjh_time]');";//修改sql
	$query=mysql_query($sql);
	if($query)
	{
		echo "<script> alert(\"添加成功\"); location.href(\"tzgg.php\");</script>";
	}
	else
	{
		echo "<script> alert(\"添加失败\"); location.href(\"tzgg.php\");</script>";
	}
