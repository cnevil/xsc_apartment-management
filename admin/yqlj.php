			...
			<div id="content">
				<table width="100%" height="25" border="1px" cellpadding="0" cellspacing="0" bordercolor="d6dbdf">
                	<tr bgcolor="e7ecf1">
                    	...
                    	<td width="28%"  align="center"><span id="lb_head">链接图片</span></td>
                ...
                <table width="100%" height="25" border="1px" cellpadding="0" cellspacing="0" bgcolor="" bordercolor="#acadad">
                    <?php
                   		$sql_sel = "SELECT * FROM `yqlj`";
						$query_sel = mysql_query($sql_sel);
						while ($row = mysql_fetch_array($query_sel)) {
                    ?>
                	<tr>
                    	<td width="28%" align="center"><?php echo $row[lj_name]?></td><!--修改显示名称-->
						<td width="28%" align="center"><?php echo $row[lj_url]?></td><!--修改显示时间-->
						<td width="28%" align="center"><?php echo"<img src=\"../images/lj_".$row[id].".jpg\""." width=122px height=74px>" ;?></td><!--修改显示时间-->
						<td width="16%" align="center"><!--修改俩处del的值和取消的页面-->
						&nbsp;&nbsp;<input id="cz" type="button" value="修改" onclick="location.href='yqlj_upload.php?upload=<?php echo $row[id]?>'"/>&nbsp;&nbsp;<!--修改俩处upload的值和添加的页面--> </td>
                    </tr>
                   <?php
                   }
                  ?>
