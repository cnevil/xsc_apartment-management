...
if(isset($_POST[sub]))
{    $sql = "INSERT INTO `gzzd` (`gzzd_id`, `gzzd_title`, `gzzd_content`, `gzzd_time`) VALUES (NULL, '$_POST[ldjh_title]','$_POST[ldjh_content]', '$_POST[ldjh_time]');";//修改sql
	$query=mysql_query($sql);
	if($query)
	{
		echo "<script> alert(\"添加成功\"); location.href(\"gzzd.php\");</script>";
	}
	else
	{
		echo "<script> alert(\"添加失败\"); location.href(\"gzzd.php\");</script>";
	}
