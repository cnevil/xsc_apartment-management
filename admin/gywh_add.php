...
if(isset($_POST[sub]))
{    $sql = "INSERT INTO `gywh` (`gywh_id`, `gywh_title`, `gywh_content`, `gywh_time`) VALUES (NULL, '$_POST[ldjh_title]','$_POST[ldjh_content]', '$_POST[ldjh_time]');";//修改sql
	$query=mysql_query($sql);
	if($query)
	{
		echo "<script> alert(\"添加成功\"); location.href(\"gywh.php\");</script>";
	}
	else
	{
		echo "<script> alert(\"添加失败\"); location.href(\"gywh.php\");</script>";
	}
