...
if(isset($_POST[sub]))
{    $sql = "INSERT INTO `gydj` (`gydj_id`, `gydj_title`, `gydj_content`, `gydj_time`) VALUES (NULL, '$_POST[ldjh_title]','$_POST[ldjh_content]', '$_POST[ldjh_time]');";//修改sql
	$query=mysql_query($sql);
	if($query)
	{
		echo "<script> alert(\"添加成功\"); location.href(\"gydj.php\");</script>";
	}
	else
	{
		echo "<script> alert(\"添加失败\"); location.href(\"gydj.php\");</script>";
	}
