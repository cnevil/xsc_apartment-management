...
if(isset($_POST[subfile])){
	$sc=$db->upfile('../flash/','qnwm.swf',$_FILES["filename"],'application/x-shockwave-flash');//文件夹地址 文件名 文件本地地址 文件类型]
	if($sc){
			...
			<div id="content_mima">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<form name="fileset" method="post"  enctype="multipart/form-data" action=""  onsubmit="return checkfile()">
                    	<tr>
                        	<td height="30"><span id="tb">上传banner：<input type="file"  name="filename"/> </span><span id="warn">注意，请上传宽1000px.高120的swf文件</span></td>
                        </tr>
                        <tr>
