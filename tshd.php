...
<div id="main_list">
	<div id="main_list_left">
			<div id="main_list_left_top">
				您的位置：<a href="index.php">首页</a>=><a href="tshd.php">特色活动</a>
			</div>
			<div id="main_list_left_middle">
				<div id="main_list_left_title">
					<ul>
							<?
							$query=mysql_query("SELECT * FROM `gg` ORDER BY `gg_time` desc  LIMIT $start_page, $xsgs");
							while($row=mysql_fetch_array($query)){
							?>
								<li><a href="tshd_content.php?id=<?php echo $row[gg_id]?>"><?php echo $row[gg_title]?></a></li>
							<?
							}
							?>
...
<img src="images/tshd_bj.jpg" width="200" height="600" border="0"  />
	</div>
</div>
<div id="four">
		<?php
