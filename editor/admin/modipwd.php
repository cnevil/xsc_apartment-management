...
function ShowForm(){
	...
	<tr>
		<td width="15%">新用户名：</td>
		<td width="55%"><input type=text class=input size=20 name=newusr value="<?php echo htmlspecialchars($_SESSION["eWebEditor_User"])?>"></td>
		<td width="30%"><span class=red>*</span>&nbsp;&nbsp;旧用户名：<span class=blue><?php echo htmlspecialchars($_SESSION["eWebEditor_User"])?></span></td>
	</tr>
	<tr>
