...
if(isset($_GET[page])){
	...
	$query_page=mysql_query("SELECT * FROM `gywh`");//修改取出的数据库d
...
<div id="main_list">
	<div id="main_list_left">
			<div id="main_list_left_top">
				您的位置：<a href="index.php">首页</a>=><a href="gywh.php">公寓文化</a>
			</div>
			<div id="main_list_left_middle">
				<div id="main_list_left_title">
					<ul>
							<?
							$query=mysql_query("SELECT * FROM `gywh` ORDER BY `gywh_time` desc  LIMIT $start_page, $xsgs");
							while($row=mysql_fetch_array($query)){
							?>
								<li><a href="gywh_content.php?id=<?php echo $row[gywh_id]?>"><?php echo $row[gywh_title]?></a></li>
							<?
							}
							?>
